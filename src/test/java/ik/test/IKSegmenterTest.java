...
public class IKSegmenterTest {
    ...
    public void print(String str) {
        try {
            ...
            while ((l = ik.next()) != null) {
                if (l.getProps().equals("filter_list")) {
                    int length = l.getLexemeText().length();
                    int position = 0;
                    ...
                    System.out.println(s.toString().trim()+ "----敏感词过滤::" + l.getProps());
                } else if (l.getProps().equals("cn_medicine")) {
                    System.out.println(l.getLexemeText() + "----中草药::" + l.getProps());
                }else {
                    System.out.println(l.getLexemeText() + "----其它类型::" + l.getProps());
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void test11() throws IOException {
        String str = "主席习近平，是领袖，，nn,银耳是一种药材,如果使用filter_list单词会怎样？";
        //做敏感词分析
        print(str);
    }
    ...
    public void test1() throws IOException {
        String str = "张三 羌活　独活　柴胡　前胡　枳壳　茯苓　荆芥　防风　桔梗　川芎各一钱五分（各5g）　甘草五分（3g）";
        //做敏感词分析
        print(str);
    }
